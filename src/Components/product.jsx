        ...
        <section className="welcome-background p-lg-1 px-4 text-center text-md-start" id="product">
            <div className="container">
                <div className="row about product align-items-center justify-content-between">
                    <div className="col-md col-lg-6 my-lg-0 mt-5 mb-4">
                        ...
                        <motion.button whileHover={{scale:1.05}} whileTap={{scale:0.95}} initial={{opacity:0}} animate={{opacity:1, transition:{duration:1.5}}} className="btn text-white welcome-glass mt-2">Read More <i className="bi bi-chevron-right"></i></motion.button>
                    </div>
